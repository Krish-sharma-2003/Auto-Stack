...
import { vendors, products, units } from '@/data/mockData';
...
export function PurchaseEntry() {
  ...
  const purchaseNo = `PE-${new Date().getFullYear()}-${String(Math.floor(Math.random() * 1000) + 1).padStart(3, '0')}`;
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      setTimeout(() => {
        setVendorName('Sun Pharma Distributors Pvt Ltd');
        setInvoiceNo('SP-INV-2024-0892');
        setItems([
          { id: generateId(), productId: '1', product: 'Paracetamol 500mg', hsn: '3004', qty: 500, unit: 'Strips', rate: 25, discount: 0, amount: 12500 },
          { id: generateId(), productId: '2', product: 'Azithromycin 500mg', hsn: '3004', qty: 200, unit: 'Strips', rate: 120, discount: 0, amount: 24000 },
        ]);
    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        ...
        <div className="p-6 border-b border-slate-100 bg-slate-50">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-slate-800">Purchase Entry</h2>
              <p className="text-sm text-slate-500">Record purchase from vendor</p>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div className="text-right">
                <p className="text-sm text-slate-500">Entry No</p>
                <p className="font-semibold text-blue-600">{purchaseNo}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <select
              ...
              className="w-full md:w-64 px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
                ...
                <div className="p-4 bg-slate-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-slate-800">{invoiceImage.name}</p>
                      <p className="text-sm text-slate-500">
                        {(invoiceImage.size / 1024).toFixed(1)} KB
                      </p>
                    </div>
      ...
      {showUploadModal && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-semibold text-slate-800 mb-4">Upload Invoice for AI Processing</h3>
            <label className="block border-2 border-dashed border-slate-300 rounded-lg p-8 text-center cursor-pointer hover:border-blue-400 transition-colors">
              ...
              <p className="text-slate-600 mb-1">Click to browse or drag and drop</p>
