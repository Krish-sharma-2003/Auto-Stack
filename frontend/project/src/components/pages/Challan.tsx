      ...
      >
        ...
        <div className="p-6 border-b border-slate-100 bg-slate-50">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-slate-800">Delivery Challan</h2>
              <p className="text-sm text-slate-500">Create delivery challan for goods</p>
            </div>
            <div className="text-right">
              <p className="text-sm text-slate-500">Challan No</p>
              <p className="font-semibold text-blue-600">{challanNo}</p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  const party = parties.find(p => p.name === e.target.value);
                  if (party) {
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200">
                    ...
                    <th className="text-left px-4 py-3 text-xs font-semibold text-slate-500 w-24">Qty</th>
        ...
        <div className="p-6 border-t border-slate-100 bg-slate-50 flex gap-3 justify-end">
          ...
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="px-4 py-2 border border-slate-200 rounded-lg text-slate-600 hover:bg-white transition-colors flex items-center gap-2 bg-blue-50 text-blue-600"
          >
          ...
          >
            ...
            >
              <div className="text-center mb-6 border-b border-slate-200 pb-4">
                <h2 className="text-xl font-bold text-slate-800">StockFlow Medicals Pvt Ltd</h2>
                <p className="text-sm text-slate-500">Delivery Challan</p>
              </div>
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  <p className="text-sm text-slate-500">Challan No</p>
                  <p className="font-semibold">{challanNo}</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-slate-500">Date</p>
                  <p className="font-semibold">{challanDate}</p>
                </div>
              </div>
              <div className="mb-4">
                ...
                {selectedParty && (
                  <p className="text-sm text-slate-600">{selectedParty.address}</p>
                )}
              </div>
              <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{vehicleNo || '---'}</p>
                </div>
              </div>
